...
fun AppBottomBar(
    ...
    val showBottomBar by remember { derivedStateOf { currentScreen in com.lumen1024.presentation.HOME_PAGE_BOTTOM_BAR_ITEMS } }
    AnimatedVisibility(
        showBottomBar,
        ...
        NavBar(
            modifier = modifier,
            items = com.lumen1024.presentation.HOME_PAGE_BOTTOM_BAR_ITEMS,
